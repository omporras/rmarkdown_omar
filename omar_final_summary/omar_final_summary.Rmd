...
The tool that I have used the most is Tidyverse followed by ggplot2
...
I wish I had attended week 1 at data school. I feel that I missed a lot because everyone seems great. Aside from that my experience in data school has been rich. I have been able to use my newly acquired data school skills in my daily work. A specific example of this has been producing an output (a protein list) that tells me the degree of protein redundancy that I have in my proteomics work. This was a task that would take me between 3-4 hours in excel. Now it takes me 45 seconds. Very embarrasing. Never again. At a personal level, being able to be more efficient with my time makes me feel more at ease and happy with myself.
